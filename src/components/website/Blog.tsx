            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center gap-2 mt-12">
                <button
                  ...
                  className="px-4 py-2 rounded-lg border border-slate-200 bg-white text-slate-600 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-50 transition"
                >
                  Previous
                </button>
                ...
                <div className="flex gap-1 overflow-x-auto max-w-full px-2 py-1">
                  {Array.from({ length: totalPages }).map((_, i) => (
                    <button
                      ...
                      className={`min-w-[40px] h-10 px-2 rounded-lg flex items-center justify-center transition-colors ${
                        currentPage === i + 1
